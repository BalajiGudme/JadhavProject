...
const Layout = () => {
  ...
  // Handle login button click - Desktop
  const handleLogin = () => {
    setShowLoginModal(true);
  };

  // Handle signup button click - Desktop
  const handleSignUp = () => {
    setShowRegisterModal(true);
  };

  // Handle login button click - Mobile
  ...
  // Handle signup button click - Mobile
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col" style={{ fontFamily: "'Red Hat Display', sans-serif" }}>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Mobile Navigation - with click outside detection */}
          {mobileMenuOpen && (
            <div 
              ref={mobileMenuRef}
            ...
            >
              <div className="py-3">
                <nav className="flex flex-col space-y-1 px-2">
                  ...
                  {/* Login/Signup for non-logged in users on mobile */}
                  {!isLoggedIn && (
      ...
      <footer className="bg-[#0d1321] text-gray-300 py-6">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
          ...
          <p className="text-sm text-center md:text-left">
            ✉️ jadhavnamdev29@gmail.com | 📞 +91 7498551060 | Maulicard. All rights reserved.
          </p>
