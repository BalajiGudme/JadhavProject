...
const DesktopMonitorSlideshow = () => {
  ...
  <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-2 sm:p-4">
    <div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl lg:max-w-6xl mx-2 sm:mx-4 md:mx-auto max-h-[90vh] sm:max-h-[95vh] overflow-y-auto">
      {/* Header */}
      <div className="flex justify-between items-center p-4 sm:p-6 border-b sticky top-0 bg-white z-10">
        <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-800 truncate pr-2">
          Upload 3 Slides for Small Panel
        </h3>
        <button
          onClick={handleCloseEditModal}
          className="text-gray-500 hover:text-gray-700 text-xl sm:text-2xl bg-gray-100 hover:bg-gray-200 w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center flex-shrink-0 transition-colors"
      ...
      <div className="p-3 sm:p-4 md:p-6">
        ...
        {!authenticated && (
          <div className="mb-4 sm:mb-6 p-3 sm:p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
            <p className="text-yellow-800 font-medium text-sm sm:text-base mb-2">
              You need to be logged in to upload images.
            </p>
            <button
              onClick={handleSetToken}
              className="px-3 sm:px-4 py-2 bg-yellow-600 hover:bg-yellow-700 text-white rounded-lg text-xs sm:text-sm font-medium w-full sm:w-auto"
            >
              Set JWT Token
            </button>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-6 mb-6 sm:mb-8">
          {[0, 1, 2].map((index) => (
            <div key={index} className="bg-gray-50 rounded-xl p-3 sm:p-4">
              <h4 className="font-semibold text-gray-700 mb-3 sm:mb-4 text-center text-sm sm:text-base">
                Slide {index + 1}
              </h4>
              
              {/* Current Image */}
              <div className="mb-3 sm:mb-4">
                <p className="text-xs sm:text-sm text-gray-500 mb-1 sm:mb-2">Current:</p>
                <div className="relative h-28 sm:h-32 md:h-40 w-full rounded-lg overflow-hidden border border-gray-300">
                  <img
              ...
              {/* File Upload Area */}
              <div 
                className="border-2 border-dashed border-gray-300 rounded-lg p-2 sm:p-3 md:p-4 mb-3 sm:mb-4 cursor-pointer hover:border-blue-500 hover:bg-blue-50 transition-colors min-h-[120px] sm:min-h-[140px] flex items-center justify-center"
                onClick={() => fileInputRefs[index].current.click()}
                role="button"
                tabIndex={0}
                onKeyDown={(e) => e.key === 'Enter' && fileInputRefs[index].current.click()}
              >
                <input
                  type="file"
                  ref={fileInputRefs[index]}
                ...
                {editFiles[index] ? (
                  <div className="text-center w-full">
                    <div className="relative h-20 sm:h-24 md:h-32 w-full rounded-lg overflow-hidden mb-1 sm:mb-2 mx-auto">
                      <img
                    ...
                    <p className="text-xs sm:text-sm text-gray-600 truncate px-1">
                      {editFiles[index].name}
                    </p>
                  </div>
                ) : (
                  <div className="py-4 sm:py-6 text-center">
                    <div className="text-2xl sm:text-3xl mb-1 sm:mb-2 text-gray-400">📤</div>
                    <p className="text-gray-500 text-xs sm:text-sm">Select image</p>
                    <p className="text-gray-400 text-xs mt-1 hidden sm:block">Click or drag & drop</p>
                  </div>
                )}
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                <button
                  onClick={() => fileInputRefs[index].current.click()}
                  className="px-3 sm:px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-xs sm:text-sm rounded-lg flex-1"
                >
                ...
                {editFiles[index] && (
                  <button
                    ...
                    className="px-3 sm:px-4 py-2 bg-red-600 hover:bg-red-700 text-white text-xs sm:text-sm rounded-lg"
                  >
                    Remove
                  </button>
                )}
        ...
        {/* Status Bar */}
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 sm:gap-0 mb-4 sm:mb-6 p-3 sm:p-4 bg-gray-100 rounded-lg">
        ...
        {/* Footer Actions */}
        <div className="flex flex-col-reverse sm:flex-row justify-end gap-3 sm:gap-4 pt-3 sm:pt-4 border-t">
          <button
            onClick={handleCloseEditModal}
            className="px-4 sm:px-6 py-2.5 sm:py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 text-sm sm:text-base w-full sm:w-auto"
            disabled={isUploading}
          >
            Cancel
          </button>
          <button
            ...
            className={`px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg font-medium text-sm sm:text-base w-full sm:w-auto ${
  ...
  <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-2 sm:p-4">
    <div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl lg:max-w-6xl mx-2 sm:mx-4 md:mx-auto max-h-[90vh] sm:max-h-[95vh] overflow-y-auto">
      ...
      <div className="flex justify-between items-center p-4 sm:p-6 border-b sticky top-0 bg-white z-10">
        <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-800 truncate pr-2">
          Upload 3 Slides for Monitor Screen
        </h3>
        <button
          ...
          {[0, 1, 2].map((index) => (
            <div key={index} className="bg-gray-50 rounded-xl p-3 sm:p-4">
              ...
              <div 
                ...
                role="button"
                tabIndex={0}
                onKeyDown={(e) => e.key === 'Enter' && monitorFileInputRefs[index].current.click()}
              >
                <input
                  type="file"
                  ref={monitorFileInputRefs[index]}
...
const LandingPage = ({ showAdminLogin = false }) => {
  ...
  // Open popup automatically when route is /admin-login
  useEffect(() => {
    if (showAdminLogin) {
      setIsAdminOpen(true);
    }
  ...
  // PORTFOLIO CRUD OPERATIONS - UPDATED FOR FILE UPLOAD
  const addPortfolio = async () => {
    // Validate required fields
    const requiredFields = ['category', 'title', 'client', 'year'];
    for (const field of requiredFields) {
      if (!newPortfolio[field]) {
    ...
    if (isNaN(newPortfolio.year) || newPortfolio.year < 2000 || newPortfolio.year > 2030) {
    ...
    try {
      ...
      formData.append('year', parseInt(newPortfolio.year));
  ...
  const updatePortfolio = async () => {
    if (!editingPortfolio) {
      alert('No portfolio item selected for editing');
      return;
    }
    ...
    // Validate year is a number
    if (isNaN(editingPortfolio.year) || editingPortfolio.year < 2000 || editingPortfolio.year > 2030) {
      alert('Please enter a valid year between 2000 and 2030');
      return;
    }
    ...
    try {
      // Create FormData for file upload
      const formData = new FormData();
      formData.append('category', editingPortfolio.category);
      formData.append('title', editingPortfolio.title);
      formData.append('client', editingPortfolio.client);
      formData.append('year', parseInt(editingPortfolio.year));
  ...
  const addTestimonial = async () => {
    if (!newTestimonial.text || !newTestimonial.author || !newTestimonial.position) {
      alert('Please fill in all required fields (text, author, position)');
      return;
    }
    ...
    try {
      // Prepare testimonial data - avatar is optional
      const testimonialData = {
        text: newTestimonial.text,
        author: newTestimonial.author,
        position: newTestimonial.position,
        avatar: newTestimonial.avatar || generateAvatarInitials(newTestimonial.author)
      };
      ...
      if (response.ok) {
        ...
        if (errorData.avatar && errorData.avatar[0]?.includes('file')) {
          ...
          const retryResponse = await fetch('http://127.0.0.1:8000/api/testimonials/', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
              'Authorization': `Bearer ${token}`,
          ...
          if (retryResponse.ok) {
            ...
            setNewTestimonial({ text: '', author: '', position: '', avatar: '' });
            setShowTestimonialModal(false);
            alert('Testimonial added successfully (without avatar)!');
          } else {
            const retryError = await retryResponse.json();
            alert(`Failed to add testimonial: ${JSON.stringify(retryError)}`);
          }
        } else {
          alert(`Failed to add testimonial: ${JSON.stringify(errorData)}`);
        }
      }
    } catch (error) {
  ...
  const updateTestimonial = async () => {
    if (!editingTestimonial || !editingTestimonial.text || !editingTestimonial.author || !editingTestimonial.position) {
      alert('Please fill in all required fields');
      return;
    }
    ...
    try {
      // Try with avatar first
      const testimonialData = {
        text: editingTestimonial.text,
        author: editingTestimonial.author,
        position: editingTestimonial.position,
        avatar: editingTestimonial.avatar || generateAvatarInitials(editingTestimonial.author)
      };
      ...
      if (response.ok) {
        ...
        if (errorData.avatar && errorData.avatar[0]?.includes('file')) {
          ...
          const retryResponse = await fetch(`http://127.0.0.1:8000/api/testimonials/${editingTestimonial.id}/`, {
            method: 'PUT',
            headers: {
              'Content-Type': 'application/json',
              'Authorization': `Bearer ${token}`,
          ...
          if (retryResponse.ok) {
            ...
            setEditingTestimonial(null);
            alert('Testimonial updated successfully (without avatar)!');
          } else {
            const retryError = await retryResponse.json();
            alert(`Failed to update testimonial: ${JSON.stringify(retryError)}`);
          }
        } else {
  ...
  // Clear preview URL when component unmounts or modal closes
  useEffect(() => {
    return () => {
      if (previewUrl) {
...
{/* Edit/Add Portfolio Modal */}
      {(editingPortfolio || showPortfolioModal) && (
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-2 sm:p-4">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl mx-2 sm:mx-4 max-h-[90vh] sm:max-h-[95vh] overflow-y-auto">
            {/* Header */}
            <div className="flex justify-between items-center p-4 sm:p-6 border-b sticky top-0 bg-white z-10">
            ...
            <div className="p-3 sm:p-4 md:p-6">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                ...
                <div className="space-y-3 sm:space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 sm:px-4 py-2 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none"
                    />
                  </div>
                ...
                <div className="space-y-3 sm:space-y-4">
                  <div>
                    ...
                    <div 
                      className="border-2 border-dashed border-gray-300 rounded-lg p-3 sm:p-4 text-center cursor-pointer hover:border-purple-500 transition-colors min-h-[140px] sm:min-h-[160px] flex items-center justify-center"
                      onClick={() => document.getElementById('portfolio-file-input').click()}
                      role="button"
                      tabIndex={0}
                      onKeyDown={(e) => e.key === 'Enter' && document.getElementById('portfolio-file-input').click()}
                    >
                      <input
                      ...
                      {portfolioFile || previewUrl ? (
                        <div className="text-center w-full">
                          <div className="relative h-24 sm:h-28 md:h-32 w-full max-w-xs mx-auto rounded-lg overflow-hidden mb-2">
                            <img
                              src={previewUrl || (editingPortfolio ? editingPortfolio.image : '')}
                              alt="Preview"
                              className="w-full h-full object-cover"
                              loading="lazy"
                            />
                          ...
                          <p className="text-xs sm:text-sm text-gray-600 truncate px-2">
                            {portfolioFile ? portfolioFile.name : 'Current Image'}
                          </p>
                        ...
                        <div className="py-4 sm:py-6">
                          <div className="text-2xl sm:text-3xl mb-1 sm:mb-2 text-gray-400">📤</div>
                          <p className="text-gray-500 text-sm sm:text-base">Click to upload image</p>
                  ...
                  <div className="mt-2 p-3 bg-gray-50 rounded-lg">
                    <p className="text-xs font-medium text-gray-700 mb-1">Image Requirements:</p>
                    <ul className="text-xs text-gray-600 space-y-1">
                      <li>• Supported formats: JPG, PNG, GIF, WebP</li>
                      <li>• Maximum file size: 5MB</li>
                      <li>• Recommended dimensions: 1200×800 pixels</li>
              ...
              {/* Action Buttons */}
              <div className="flex flex-col-reverse sm:flex-row justify-end gap-2 sm:gap-3 pt-4 sm:pt-6 mt-4 sm:mt-6 border-t">
                <button
                  onClick={() => {
                    setEditingPortfolio(null);
                    setShowPortfolioModal(false);
                  ...
                  className="px-3 sm:px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 text-sm sm:text-base w-full sm:w-auto order-2 sm:order-1"
                >
                  Cancel
                </button>
                ...
                {editingPortfolio && (
                  <>
                    <button
                      ...
                      className="px-3 sm:px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 text-sm sm:text-base w-full sm:w-auto order-1 sm:order-2"
                    >
                      Cancel Edit
                    </button>
                    <button
                      onClick={updatePortfolio}
                      className="px-3 sm:px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-lg text-sm sm:text-base w-full sm:w-auto order-3"
                    >
                      Update Portfolio
                    </button>
                  </>
                ...
                {showPortfolioModal && (
                  <button
                    ...
                    className="px-3 sm:px-4 py-2 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white rounded-lg text-sm sm:text-base w-full sm:w-auto order-1 sm:order-3"
                  >
                    Add Portfolio Item
                  </button>
                )}
      ...
      {(editingService || showServiceModal) && (
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-2 sm:p-4">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl mx-2 sm:mx-4 max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-center p-4 sm:p-6 border-b sticky top-0 bg-white z-10">
              ...
              <button
                ...
                className="text-gray-500 hover:text-gray-700 text-xl sm:text-2xl bg-gray-100 hover:bg-gray-200 w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center transition-colors"
              >
                ×
              </button>
            </div>
            ...
            <div className="p-4 sm:p-6">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                <div className="space-y-3 sm:space-y-4">
                  <div>
                    ...
                    <div className="flex items-center space-x-2">
                      <input
                        ...
                        placeholder="e.g., 🎨"
                        className="flex-1 px-3 sm:px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none text-xl sm:text-2xl text-center"
                        maxLength="2"
                      />
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1 sm:gap-2 p-2 sm:p-3 border border-gray-200 rounded-lg">
                      {emojiIcons.map((emoji, index) => (
                        <button
                          ...
                          className={`text-xl sm:text-2xl p-1 sm:p-2 rounded-lg hover:bg-gray-100 transition-colors ${
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 sm:px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none text-sm sm:text-base"
                    />
                  </div>
                </div>
                ...
                <div className="space-y-3 sm:space-y-4">
                  <div>
                    ...
                    <textarea
                      ...
                      rows="4"
                      className="w-full px-3 sm:px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none resize-none text-sm sm:text-base"
                    />
                    <p className="text-xs text-gray-500 mt-1 sm:mt-2">
              ...
              <div className="flex flex-col sm:flex-row justify-end gap-2 sm:gap-3 pt-4 sm:pt-6 mt-4 sm:mt-6 border-t">
                <button
                  ...
                  className="px-3 sm:px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 text-sm sm:text-base order-2 sm:order-1"
                >
                  Cancel
                </button>
                ...
                {editingService && (
                  <>
                    <button
                      ...
                      className="px-3 sm:px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 text-sm sm:text-base order-1 sm:order-2"
                    >
                      Cancel Edit
                    </button>
                    <button
                      onClick={updateService}
                      className="px-3 sm:px-4 py-2 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white rounded-lg text-sm sm:text-base order-3"
                    >
                      Update Service
                    </button>
                  </>
                ...
                {showServiceModal && (
                  <button
                    onClick={addService}
                    className="px-3 sm:px-4 py-2 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white rounded-lg text-sm sm:text-base order-1 sm:order-3"
                  >
                    Add Service
                  </button>
                )}
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-3 sm:space-x-4">
                      <input
                        ...
                        placeholder="e.g., SJ"
                        className="w-16 sm:w-20 px-2 sm:px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none text-center uppercase text-sm sm:text-base"
                        maxLength="2"
                      />
                      <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-purple-600 to-pink-600 rounded-full flex items-center justify-center font-bold text-white text-sm sm:text-base">
                        {editingTestimonial ? editingTestimonial.avatar || generateAvatarInitials(editingTestimonial.author) 
                          : newTestimonial.avatar || generateAvatarInitials(newTestimonial.author) || '??'}
                      </div>
                    </div>
                    <p className="text-xs text-gray-500 mt-1 sm:mt-2">
                      1-2 character initials (optional - will be generated from name if left empty)
                    </p>
                  </div>
                  
                  <div className="mt-4 sm:mt-6">
                    <p className="text-sm font-medium text-gray-700 mb-1 sm:mb-2">Preview:</p>
                    <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-3 sm:p-4 rounded-lg border border-gray-700 text-white">
                      <div className="text-xl sm:text-2xl mb-2 sm:mb-3 text-purple-400">"</div>
                      <p className="text-xs sm:text-sm text-gray-300 mb-3 sm:mb-4 italic">
                        {editingTestimonial ? editingTestimonial.text : newTestimonial.text || 'Testimonial text will appear here...'}
                      </p>
                      <div className="flex items-center">
                        <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-r from-purple-600 to-pink-600 rounded-full flex items-center justify-center font-bold text-white mr-2 sm:mr-3 text-xs sm:text-sm">
                          {editingTestimonial ? editingTestimonial.avatar || generateAvatarInitials(editingTestimonial.author) 
                            : newTestimonial.avatar || generateAvatarInitials(newTestimonial.author) || '??'}
                        </div>
                        <div>
